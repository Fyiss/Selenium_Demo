...
public class Assignment_Darshith {
	WebDriver driver;
	...
	public void Create_Order(String select) {
		...
		String expValue = driver
				.findElement(By.xpath("//td[normalize-space()='" + select + "']/following-sibling::td[1]")).getText();
		...
		String actValue = driver.findElement(By.xpath("//input[@id='ctl00_MainContent_fmwOrder_txtUnitPrice']"))
				.getAttribute("value");
